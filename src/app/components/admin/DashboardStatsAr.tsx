...
export function DashboardStatsAr({ accessToken }: DashboardStatsProps) {
  ...
  const loadStats = async () => {
    try {
      ...
      setStats(prev => ({
        ...prev,
        loading: false,
        error: err.message || 'فشل تحميل الإحصائيات',
      }));
    }
  };
    ...
    <div className="space-y-6">
      {stats.error && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="text-right">
            <p className="text-red-900 font-medium">خطأ في تحميل الإحصائيات</p>
