export function generateNewsletterTemplate(subject, content, language = 'en') {
...
.header { background: linear-gradient(135deg, #333333 0%, #555555 100%); color: white; padding: 40px 20px; text-align: center; }
